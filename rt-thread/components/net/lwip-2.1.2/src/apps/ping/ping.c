...
//	  rt_kprintf("iecho->PACK_STRUCT_FLD_8(u8_t type)=%x \n",iecho->PACK_STRUCT_FLD_8(type));
//		rt_kprintf("iecho->PACK_STRUCT_FLD_8(u8_t code)=%x \n",iecho->PACK_STRUCT_FLD_8(code));
//		rt_kprintf("iecho->PACK_STRUCT_FIELD(u16_t chksum)=%x \n",iecho->PACK_STRUCT_FIELD(chksum));
//		rt_kprintf("iecho->PACK_STRUCT_FIELD(u16_t id)=%x \n",iecho->PACK_STRUCT_FIELD(id));
